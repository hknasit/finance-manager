...
/**
 * Landing page component for CashFlow app.
 *
 * This component displays the landing page for the CashFlow app,
 * which includes a hero section, features section, how it works section,
 * and a call-to-action section. It also includes a footer section
 * with links to the about, privacy, terms, and contact pages.
 */
const LandingPage = () => {
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-8 md:mb-0 text-center md:text-left">
              ...
              <p className="text-lg md:text-xl text-gray-600 mb-6 md:mb-8 max-w-md mx-auto md:mx-0">
                Comprehensive financial tracking for both personal and part-time
                income. Monitor expenses, analyze spending patterns, and export
                detailed reports.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                <a
                  href={`${baseUrl}/register`}
                  className="inline-flex items-center justify-center px-6 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors text-base md:text-lg"
                >
                  Start Tracking
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-8">
            {[
              {
                icon: (
                  <Receipt className="w-5 h-5 md:w-6 md:h-6 text-green-600" />
                ),
                title: "Income & Expense Tracking",
                description:
                  "Track both card and cash transactions with detailed categorization",
              },
              {
                icon: (
                  <PieChart className="w-5 h-5 md:w-6 md:h-6 text-green-600" />
                ),
                title: "Visual Analytics",
                description:
                  "Understand your spending patterns with intuitive pie charts and analysis",
              },
              {
                icon: (
                ...
                description:
                  "View and manage transactions with detailed monthly breakdowns",
              },
              {
                icon: (
                  <FileClock className="w-5 h-5 md:w-6 md:h-6 text-green-600" />
                ),
                title: "Part-time Income",
                description:
                  "Track salary, tips, and tax deductions for part-time work",
              },
              {
                icon: (
                ...
                title: "Excel Reports",
                description:
                  "Generate and export detailed financial reports to Excel",
              },
              {
                icon: (
              ...
              <div
                key={index}
                className="p-4 md:p-6 border rounded-xl hover:shadow-lg transition-shadow"
              >
            ...
            {[
              {
                ...
                description:
                  "Record your daily income and expenses with detailed categories",
              },
              {
                step: "2",
                title: "Track Progress",
                description:
                  "Monitor your financial health with real-time analytics",
              },
              {
                step: "3",
                title: "Generate Reports",
                description:
                  "Export detailed Excel reports for better financial planning",
              },
            ].map((item, index) => (
      ...
      <section className="bg-green-600 py-12 md:py-16">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-white mb-6 md:mb-8 max-w-2xl mx-auto text-sm md:text-base">
            Join other users who are tracking their finances effectively with
            CashFlow.
          </p>
          <a
            href={`${baseUrl}/register`}
            className="inline-flex items-center px-6 py-3 bg-white text-green-600 rounded-lg hover:bg-green-50 transition-colors text-base md:text-lg"
          >
            Create Free Account
            <ArrowRight className="ml-2 w-5 h-5" />
          </a>
